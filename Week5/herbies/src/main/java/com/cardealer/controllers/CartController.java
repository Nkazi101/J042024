...
public class CartController {
    ...
    public String viewCart(HttpSession session, Model model){
        ...
        //get cart previously set in the user session, or set a new cart if no cart has been set
        Cart cart = cartService.getCart(session);

        //the data we want to pass to cart webpage is whatever items are currently in the cart
